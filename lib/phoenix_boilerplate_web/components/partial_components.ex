defmodule PhoenixBoilerplateWeb.PartialComponents do
  use Phoenix.Component
  use PhoenixBoilerplateWeb, :verified_routes

  def dropdown_notification(assigns) do
    ~H"""
    <div
      ...
      phx-click-away={
        PhoenixBoilerplateWeb.Layouts.App.toggle_menu_dropdown("#dropdown_notification")
      }
    >
  ...
  def dropdown_message(assigns) do
    ~H"""
    <div
      id="dropdown_message"
      class="absolute -right-16 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80 hidden"
      phx-click-away={PhoenixBoilerplateWeb.Layouts.App.toggle_menu_dropdown("#dropdown_message")}
    >
      <div class="px-4.5 py-3">
  ...
  def dropdown_menu_account(assigns) do
    ~H"""
    <div
      id="dropdown_menu_account"
      ...
      phx-click-away={
        PhoenixBoilerplateWeb.Layouts.App.toggle_menu_dropdown("#dropdown_menu_account")
      }
    >
  ...
  @spec sidebar(any()) :: Phoenix.LiveView.Rendered.t()
    ...
    >
      ...
      <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <.link navigate={~p"/dashboard"}>
          <img src="/images/logo/logo-dark.svg" alt="Logo" class="max-h-[70px] ml-4" />
        </.link>

        <button
          class="block lg:hidden"
          phx-click={PhoenixBoilerplateWeb.Layouts.App.toggle_sidebar_menu()}
        >
          <svg
            class="fill-current"
            width="20"
      ...
      <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul class="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <.link
                  class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                  patch={~p"/dashboard/transactions"}
                >
                  <svg
                    class="fill-current"
                    width="18"
              ...
              <!-- Menu Item Calendar -->
                    ...
                    <!-- Menu Item Profile -->
              <li :if={@current_user.role.name == "superadmin" or @current_user.role.name == "admin"}>
                <.link
                  class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                  patch={~p"/dashboard/member"}
                >
                  <svg
                    class="fill-current"
                    width="18"
          ...
          <div :if={@current_user.role.name == "superadmin" or @current_user.role.name == "admin"}>
            <h3 class="mb-4 ml-4 text-sm font-medium text-bodydark2">DATA</h3>
          ...
          >
            <span class="relative block h-5.5 w-5.5 cursor-pointer">
              <span class="du-block absolute right-0 h-full w-full">
                <span class="hmbgr-item relative left-0 top-0 my-1 block h-0.5 w-full rounded-sm bg-black delay-[0] duration-200 ease-in-out dark:bg-white">
                </span>
                <span class="hmbgr-item relative left-0 top-0 my-1 block h-0.5 w-full rounded-sm bg-black delay-150 duration-200 ease-in-out dark:bg-white">
                </span>
                <span class="hmbgr-item relative left-0 top-0 my-1 block h-0.5 w-full rounded-sm bg-black delay-200 duration-200 ease-in-out dark:bg-white">
                </span>
              </span>
        ...
        <div class="flex items-center gap-3 2xsm:gap-7">
          <ul class="flex items-center gap-2 2xsm:gap-4">
            ...
            <li class="relative">
              ...
              <!-- Dropdown Start -->
              <PhoenixBoilerplateWeb.PartialComponents.dropdown_notification />
              <!-- Dropdown End -->
            </li>
            <!-- Notification Menu Area -->
            ...
            <li class="relative">
              <a
                ...
                href="#"
                phx-click={
                  PhoenixBoilerplateWeb.Layouts.App.toggle_menu_dropdown("#dropdown_message")
                }
              >
              ...
              <!-- Dropdown Start -->
              <PhoenixBoilerplateWeb.PartialComponents.dropdown_message />
              <!-- Dropdown End -->
            </li>
            <!-- Chat Notification Area -->
          </ul>
          ...
          <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
            ...
            <!-- Dropdown Start -->
            <PhoenixBoilerplateWeb.PartialComponents.dropdown_menu_account />
            <!-- Dropdown End -->
          </div>
          <!-- User Area -->
        </div>
    ...
    <nav aria-label="Page navigation example" class="mt-4">
      <ul class="flex items-center -space-x-px h-8 text-sm">
        <li>
          <a
            href="#"
            class="flex items-center justify-center px-3 h-8 ms-0 leading-tight text-gray-500 bg-white border border-e-0 border-slate-200 rounded-s-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
          >
        ...
        <li>
          <a
            href="#"
            class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-slate-200 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
          >
            1
          </a>
        </li>
        ...
        <li>
          <a
            href="#"
            class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-slate-200 rounded-e-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
          >
