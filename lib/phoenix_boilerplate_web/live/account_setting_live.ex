defmodule PhoenixBoilerplateWeb.AccountSettingLive do
    ...
    <main>
      <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        <div class="mx-auto max-w-270">
          <PhoenixBoilerplateWeb.PartialComponents.custom_header>
            Account Setting
          </PhoenixBoilerplateWeb.PartialComponents.custom_header>
          <div class="grid grid-cols-5 gap-8">
            <div class="col-span-5 xl:col-span-3">
              ...
              <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark mt-8">
                <div class="border-b border-stroke px-7 py-4 dark:border-strokedark">
                  <h3 class="font-medium text-black dark:text-white">
                    Password
                  </h3>
                  ...
                  <form action="#">
                    <div class="mb-4 flex items-center gap-3">
                      <div class="h-14 w-14 rounded-full">
                        <img src={~p"/images/user/user-03.png"} alt="User" />
                      </div>
                      <div>
  ...
  def mount(_params, _session, socket) do
    ...
    socket =
      socket
      |> assign(page_title: "Account setting")
